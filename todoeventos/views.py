...
def eventos(request):
	...
	return render_to_response('lista_articulos.html', {'chicas': chicas, 'articulos': articulos, 'banners':banners, 'servicios': servicios}, context_instance=RequestContext(request))
